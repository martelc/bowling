...
public class AllSpareGameFactoryTest {
    @Test
    public void createGame_withTenFramesTwoBallsAndOneBonusBallPerFrameTenPointsPerTwoBalls_returnsValidGame() {
        ...
        Game game = AllSpareGameFactory.createGame(scoringStrategyMock);

        Integer expectedNumberOfBallsPerFrame = 2;
        Integer expectedNumberOfBonusBallsPerFrame = 1;
