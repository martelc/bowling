...
import martelc.bowling.domain.factories.AllOpenGameFactory;
...
public class AllOpenGameTenPinScoringStrategyTest {
    ...
    public void addBallToFramesAndCalculatePoints_withRollAddedAfterLastBallOfLastFrame_returnsZeroCalculatedPoints() {
        ...
        Game game = AllOpenGameFactory.createGame(tenPinScoringStrategyUnderTest);
